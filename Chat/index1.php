...
<?php include 'nav.php'; ?>
    ...
    <header>
        <div class="container header-section flex">
            ...
            <div class="header-right">
                <img src="img/web-overview.jpg" alt="websiteInfo">
            </div>
        </div>
    </header>
    ...
    <section class="feature-section">
        <div class="container flex feature-container">
            <div class="feature-img">
                <img src="img/project-showcase.jpg" alt="projectShowcase">
            </div>
    ...
    <section class="feature-section">
        <div class="container flex feature-container">
            ...
            <div class="feature-img">
                <img src="img/collaboration_-tools-removebg.png" alt="collabtools">
            </div>
        </div>
    </section>
    <section class="feature-section">
        <div class="container flex feature-container">
            <div class="feature-img">
                <img src="img/upload-project.jpg" alt="uploadproject">
            </div>
            <div class="feature-desc flex">
    ...
    <section class="feature-section">
        <div class="container flex feature-container">
            ...
            <div class="feature-img">
                <img src="img/download-project.png" alt="downloadprojects">
            </div>
        </div>
    </section>
